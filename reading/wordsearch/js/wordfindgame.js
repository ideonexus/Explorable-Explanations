    ...
    */
    var drawWords = function (el, words) {
      ...
      for (var i = 0, len = words.length; i < len; i++) {
        var word = words[i];
        output += '<li class="word ' + word + '">' + word.toUpperCase() + '</li>';
      }
      output += '</ul>';
    ...
    var endTurn = function () {
      ...
      for (var i = 0, len = wordList.length; i < len; i++) {
        ...
        if (wordList[i] === curWord) {
          ...
          //Read sentence if function defined. ras 20151030
          if (typeof readSentence !== 'undefined' && $.isFunction(readSentence)) {
              readSentence(curWord);
          }
        }
        ...
        if (wordList.length === 0) {
          ...
          //Win Animation if function defined. ras 20151030
          if (typeof winAnimation !== 'undefined' && $.isFunction(winAnimation)) {
              winAnimation();
          }
        }
      }
